...
os.environ["DATABASE_URL"] = "sqlite:///./test_lost_found.db"
...
async def run_tests_async():
    ...
    try:
        ...
        async with httpx.AsyncClient(transport=transport, base_url="http://testserver") as client:
            ...
            matches_res = await client.get("/matches/?min_confidence=0.0", headers=headers_alice)
        ...
        test_db = os.path.abspath(os.path.join(os.path.dirname(__file__), "test_lost_found.db"))
